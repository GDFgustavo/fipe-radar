...
export default function LoginPage() {
    ...
    const cadastroUrl = redirectTarget
        ? `/cadastro?redirect=${encodeURIComponent(redirectTarget)}`
        : "/cadastro";
    ...
    return (
        <>
            <AuthForm
                ...
                submitText="Acessar Conta" isCaptchaVerified={true}
            >
                ...
                <div className={styles.footerLinks}>
                    ...
                    <Link href={cadastroUrl} className={styles.link}>Cadastre-se</Link>
                </div>
            </AuthForm>
